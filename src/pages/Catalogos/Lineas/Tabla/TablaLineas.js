...
const TablaLineas = ({ BotonesCabezal, ExportarRegistros, dt, products, selectedProducts, setSelectedProducts, actionBodyTemplate }) => {
        ...
        <div className="card">
            ...
            {products.length > 0 ? (
                ...
                >
                    ...
                    <Column field="linea" header="Linea" sortable filter filterPlaceholder="Buscar"
                        style={{ width: "25%", minWidth: '7rem', textAlign: 'center' }} />
                    <Column
                        field="area" header="Area" sortable filter filterPlaceholder="Buscar"
                        style={{ width: "20%", minWidth: '7rem', textAlign: 'center' }} />
                    <Column
                        field="meta" header="Meta" sortable filter filterPlaceholder="Buscar"
